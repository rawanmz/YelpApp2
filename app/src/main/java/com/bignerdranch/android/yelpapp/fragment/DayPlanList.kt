...
//
//    var binding:FragmentDayPlanListBinding?=null
...
//   @Inject var adapter = RestaurantAdapter(places)
//
//
...
//    ): View? {
//        binding = FragmentDayPlanListBinding.inflate(inflater, container, false)
//        return binding.root
//    }
//
//
...
//            val binding: ListItemDayPlanBinding =ListItemDayPlanBinding.inflate(layoutInflater, R.layout.list_item_day_plan, parent, false)
